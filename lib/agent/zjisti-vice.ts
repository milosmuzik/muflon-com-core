...
DŮLEŽITÉ: pole "rozsireni" piš v ANGLIČTINĚ (jazyk cílového webu radiomuflon.com) - i když je tenhle prompt v češtině.

Vrať POUZE JSON (bez markdown):
{"rozsireni": "2-4 sentences of new detail, in English, in your own words", "zdroje": [{"nazev": "...", "url": "https://...", "kategorie": "jedna z: oficialni_web|socialni_site|archivni|databaze|media|rozhovor|kniha|orientacni"}]}
